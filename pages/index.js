...
const portfolioData = [
  ...
  },
  {
    ...
    description: 'Managed palm oil production operations, implementing quality control measures that improved output efficiency and product standards.',
    tech: ['Quality Control', 'Operations', 'Reporting'],
  ...
  },
  {
    ...
    description: 'Completed various professional certifications and training programs in sales management, financial administration, and business operations.',
          ...
          <div className="container">
            ...
            <div className="hero-languages">
              ...
              <div className="language-badges">
                {[
                  { flag: '🇮🇩', name: 'Indonesian', level: 'native', label: 'Native' },
                  { flag: '🇬🇧', name: 'English', level: 'elementary', label: 'Elementary' },
                  { flag: '🇩🇪', name: 'German', level: 'elementary', label: 'Elementary' },
                  { flag: '🇯🇵', name: 'Japanese', level: 'elementary', label: 'Elementary' },
                ].map((lang) => (
                ...
                <div key={item.id} className="portfolio-card fade-in" onMouseEnter={addHover} onMouseLeave={removeHover}>
                  <div className="portfolio-image">
                    ...
                    <div className="portfolio-overlay">
                      {!item.noLive && (
                        <a href="#" className="view-btn" style={{ marginBottom: '0.7rem' }} target="_blank" rel="noopener">
                          <span>🚀</span> View Live Dashboard
                        </a>
                      )}
                      <a href="#" className="view-btn" onClick={(e) => e.preventDefault()}>
                        <span>{item.noLive ? '🏆' : '📸'}</span>
                        {item.noLive ? 'View Certificates' : 'View Gallery'}
                      </a>
                    </div>
                  </div>
